...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'pub_seg_lv_gb_3d    = sitl_ros2_cv.detect.pub_seg_lv_gb_3d:main',
            'pub_seg_lv_gb_post  = sitl_ros2_cv.detect.pub_seg_lv_gb_post:main',
            # detectron2 / MaskDINO
            'pub_seg_lv_gb_dt2   = sitl_ros2_cv.dt2.pub_seg_lv_gb_raw:main',
            'pub_kpt_fbf_dt2     = sitl_ros2_cv.dt2.pub_kpt_raw_fbf:main',
            'pub_kpt_pch_dt2     = sitl_ros2_cv.dt2.pub_kpt_raw_pch:main',
            # YOLOv11
            'pub_kpt_fbf_yolo    = sitl_ros2_cv.yolo.pub_kpt_raw_fbf:main',
            'pub_kpt_pch_yolo    = sitl_ros2_cv.yolo.pub_kpt_raw_pch:main',
            'pub_seg_lv_gb_yolo  = sitl_ros2_cv.yolo.pub_seg_lv_gb_raw:main',
        ],
    },
)
