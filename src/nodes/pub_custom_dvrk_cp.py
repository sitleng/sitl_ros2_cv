...
class PUB_CUSTOM_DVRK_CP():
    def __init__(self,node_name,params):
        ...
        self.custom_psm1_cp = rospy.Publisher("/PSM1/custom/setpoint_cp",TransformStamped,queue_size=10)
        self.custom_psm2_cp = rospy.Publisher("/PSM2/custom/setpoint_cp",TransformStamped,queue_size=10)
        self.custom_psm1_jaw_cp = rospy.Publisher("/PSM1/custom/jaw/setpoint_cp",TransformStamped,queue_size=10)
        self.custom_psm2_jaw_cp = rospy.Publisher("/PSM2/custom/jaw/setpoint_cp",TransformStamped,queue_size=10)
        self.custom_ecm_cp = rospy.Publisher("/ECM/custom/setpoint_cp",TransformStamped,queue_size=10)
        self.custom_psm1_local_cp = rospy.Publisher("/PSM1/custom/local/setpoint_cp",TransformStamped,queue_size=10)
        self.custom_psm2_local_cp = rospy.Publisher("/PSM2/custom/local/setpoint_cp",TransformStamped,queue_size=10)
        self.custom_psm1_local_jaw_cp = rospy.Publisher("/PSM1/custom/local/jaw/setpoint_cp",TransformStamped,queue_size=10)
        self.custom_psm2_local_jaw_cp = rospy.Publisher("/PSM2/custom/local/jaw/setpoint_cp",TransformStamped,queue_size=10)
        self.custom_ecm_local_cp = rospy.Publisher("/ECM/custom/local/setpoint_cp",TransformStamped,queue_size=10)
    ...
    def callback(self,psm1_js,psm2_js,ecm_js):
        ...
        g_psm2base_psm2jaw = g_psm1base_psm1tip.dot(self.g_psm2tip_psm2jaw)
        ...
        g_ecmtip_psm2jaw = g_ecmtip_psm1tip.dot(self.g_psm2tip_psm2jaw)
        g_odom_ecmtip = self.g_odom_ecmbase.dot(g_ecmbase_ecmtip)
        t = rospy.Time.now()

        custom_ecm_cp_msg = tf_utils.g2tfstamped(g_odom_ecmtip,t,"Cart","ECM")
        self.custom_ecm_cp.publish(custom_ecm_cp_msg)

        custom_psm1_cp_msg = tf_utils.g2tfstamped(g_ecmtip_psm1tip,t,"ECM","PSM1")
        self.custom_psm1_cp.publish(custom_psm1_cp_msg)

        custom_psm2_cp_msg = tf_utils.g2tfstamped(g_ecmtip_psm2tip,t,"ECM","PSM2")
        self.custom_psm2_cp.publish(custom_psm2_cp_msg)

        custom_psm1_jaw_cp_msg = tf_utils.g2tfstamped(g_ecmtip_psm1jaw,t,"ECM","PSM1_jaw")
        self.custom_psm1_jaw_cp.publish(custom_psm1_jaw_cp_msg)

        custom_psm2_jaw_cp_msg = tf_utils.g2tfstamped(g_ecmtip_psm2jaw,t,"ECM","PSM2_jaw")
        self.custom_psm2_jaw_cp.publish(custom_psm2_jaw_cp_msg)

        custom_psm1_local_cp_msg = tf_utils.g2tfstamped(g_psm1base_psm1tip,t,"PSM1_base","PSM1")
        self.custom_psm1_local_cp.publish(custom_psm1_local_cp_msg)

        custom_psm2_local_cp_msg = tf_utils.g2tfstamped(g_psm2base_psm2tip,t,"PSM2_base","PSM2")
        self.custom_psm2_local_cp.publish(custom_psm2_local_cp_msg)

        custom_ecm_local_cp_msg = tf_utils.g2tfstamped(g_ecmbase_ecmtip,t,"ECM_base","ECM")
        self.custom_ecm_local_cp.publish(custom_ecm_local_cp_msg)

        custom_psm1_local_jaw_cp_msg = tf_utils.g2tfstamped(g_psm1base_psm1jaw,t,"PSM1_base","PSM1_jaw")
        self.custom_psm1_local_jaw_cp.publish(custom_psm1_local_jaw_cp_msg)

        custom_psm2_local_jaw_cp_msg = tf_utils.g2tfstamped(g_psm2base_psm2jaw,t,"PSM2_base","PSM2_jaw")
